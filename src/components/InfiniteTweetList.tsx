...
function TweetCard({
  ...
  return <li id={id} className='flex gap-4 border-b px-4 py-4'>
    ...
    <div className='flex flex-grow flex-col'>
      <div className="flex gap-1">
        <Link
          ...
          className='font-bold hover:underline hover:cursor-pointer focus-visible:underline outline-none'
        >
          {user.name}
        </Link>
...
function HeartButton({ isLoading, onClick, likedByMe, likeCount }: HearButtonProps) {
